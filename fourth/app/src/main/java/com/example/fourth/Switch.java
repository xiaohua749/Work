...
public class Switch extends AppCompatActivity implements OnCheckedChangeListener{

    private android.widget.Switch sw_status; // 声明一个开关按钮对象
    private android.widget.Switch sw_ios; // 声明一个开关按钮对象
