...
import com.example.fourth.bean.UserInfo;
import com.example.fourth.database.UserDBHelper;
import com.example.fourth.util.DateUtil;
import com.example.fourth.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private android.widget.Switch ck_remember; // 声明一个开关按钮对象
