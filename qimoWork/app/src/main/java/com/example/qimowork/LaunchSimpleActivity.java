...
import com.example.qimowork.adapter.LaunchSimpleAdapter;

public class LaunchSimpleActivity extends AppCompatActivity  implements View.OnClickListener{
    // 声明引导页面的图片数组
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_start) { // 点击了“开始”按钮
            // 跳转到手机商场页面
