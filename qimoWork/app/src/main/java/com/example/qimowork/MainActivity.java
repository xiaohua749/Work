...
import com.example.qimowork.bean.UserInfo;
import com.example.qimowork.database.UserDBHelper;
import com.example.qimowork.util.DateUtil;
import com.example.qimowork.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray =  {"个人用户", "公司用户","行政人员","管理人员","18990109-秦嘉"};
